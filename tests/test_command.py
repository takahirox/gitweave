...
class CommandNodeTests(unittest.TestCase):
    ...
    def test_context_on_stdin_result_on_stdout_and_same_audit_model(self):
        ...
        self.assertEqual(context["workspace_base"], self.base)
        self.assertEqual(context["instance_id"], "cmd-1")
        self.assertEqual([i["commit"] for i in context["inputs"]], [self.base])
